...
public class IntentRecipeListActivityTest
{
    @Rule
    public IntentsTestRule<RecipeListActivity> mIntentsTestRule = new IntentsTestRule<>(
    ...
    {
        onView(withId(R.id.recipe_recycler_view)).perform(RecyclerViewActions.actionOnItem(
